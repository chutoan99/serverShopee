...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("Posts", {
      ...
      currency: { type: Sequelize.STRING(10000) },
      ...
      size_chart: { type: Sequelize.STRING(10000) },
      shop_name: { type: Sequelize.STRING(10000) },
      transparent_background_image: { type: Sequelize.STRING(10000) },
